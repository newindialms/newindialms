...
public class ProgramManagerCourseScheduleFirstYear extends AppCompatActivity {
                ...
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        ProgramScreenCourseScheduleListItems listItemProgramList = new ProgramScreenCourseScheduleListItems(
                                ...
                                jsonObject1.getString("course_date"),
                                jsonObject1.getString("course_schedule_day"),
                                jsonObject1.getString("course_schedule_time"),
                                jsonObject1.getString("student_group"),
                                jsonObject1.getString("student_batch"),
                                jsonObject1.getString("course_classroom")

                        );
                        heroList.add(listItemProgramList);
                    }
                    adapter = new ProgramScreenCourseScheduleFirstyearAdapter(getApplicationContext(),R.layout.activity_program_screencourseschedulefirstyearlistitems,heroList);
