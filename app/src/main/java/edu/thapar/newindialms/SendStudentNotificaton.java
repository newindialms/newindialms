...
public class SendStudentNotificaton extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title_notification = findViewById(R.id.send_student_notification_subtitle_hint);
        message_notification = findViewById(R.id.send_student_notification_subtitle_message_hint);
