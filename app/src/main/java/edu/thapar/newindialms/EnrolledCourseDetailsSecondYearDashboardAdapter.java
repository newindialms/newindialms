...
public class EnrolledCourseDetailsSecondYearDashboardAdapter extends ArrayAdapter<EnrolledCourseDetailsSecondYearDashboardListItems> {

    //the list values in the List of type hero
    List<EnrolledCourseDetailsSecondYearDashboardListItems> programScreenListItems;
    ...
    public EnrolledCourseDetailsSecondYearDashboardAdapter(Context context, int resource, List<EnrolledCourseDetailsSecondYearDashboardListItems> programScreenListItems) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final EnrolledCourseDetailsSecondYearDashboardListItems hero = programScreenListItems.get(position);
        ...
        course_details_details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    Intent facultyintent = new Intent(context, SecondYearFaculty.class);
