...
public class ProgramScreenAllCoursesAdapter extends ArrayAdapter<ProgramScreenAllCoursesListItems> {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView Studentpic_programstudentallcourselist_name = view.findViewById(R.id.Studentpic_programstudentallcourselist_name);
        TextView Studentpic_programstudentallcourselist_rollno = view.findViewById(R.id.Studentpic_programstudentallcourselist_rollno);
