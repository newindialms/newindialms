...
public class DisenrolledSpecializationAdapter extends ArrayAdapter<EnrollSpecializationListItems> {

    //the list values in the List of type hero
    List<EnrollSpecializationListItems> enrolledCourseListItemses;
    //activity context
    ...
    public DisenrolledSpecializationAdapter(Context context, int resource, List<EnrollSpecializationListItems> enrolledCourseListItems) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final EnrollSpecializationListItems hero = enrolledCourseListItemses.get(position);

        //adding values to the list item
        enrolledcourselist_name.setText(hero.getCoursedetails_name());
        cancelcourselist_name.setImageResource(R.drawable.cancel);

        relative1.setOnClickListener(new View.OnClickListener() {
            String coursename = hero.getCoursedetails_name();
    ...
    private void removeCoursefromDB(final String removecoursename, final String student_rollno) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, removecourselist_url, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("student_rollnno", student_rollno);
                return params;
            }
        };
