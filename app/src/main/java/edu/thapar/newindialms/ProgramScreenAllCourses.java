...
public class ProgramScreenAllCourses extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Studentpic_programstudentallcourselist_title = findViewById(R.id.Studentpic_programstudentallcourselist_title);
        Studentpic_programstudentallcourselist_title.setText(coursesname);
        heroList = new ArrayList<>();
        listView = findViewById(R.id.studentpic_programscreenstudentallcourselist_ListView);
    ...
    public void myarraycount(int rowcount) {
        Studentpic_programstudentallcourselist_total = findViewById(R.id.Studentpic_programstudentallcourselist_total);
