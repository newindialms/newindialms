...
public class FeedbackTab extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_feedback_tab);

        addcoursetoolbar = (Toolbar) findViewById(R.id.feedback_toolbar);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.add_feedback_layout, container, false);
            return rootView;
        }
    }
