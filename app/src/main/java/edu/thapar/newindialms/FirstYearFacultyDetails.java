...
public class FirstYearFacultyDetails {
    ...
    public FirstYearFacultyDetails(String facultyfirstname, String facultylastname, String facultyfirstphone,String facultyfirstemail, String facultyfirstcredits) {
