...
public class FacultyCourseListDashboardWiseAdapter extends ArrayAdapter<FacultyCourseListDashboardWiseListItems> {

    //the list values in the List of type hero
    List<FacultyCourseListDashboardWiseListItems> facultyCourseListDashboardListItems;
    ...
    public FacultyCourseListDashboardWiseAdapter(Context context, int resource, List<FacultyCourseListDashboardWiseListItems> facultyCourseListDashboardListItems) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final FacultyCourseListDashboardWiseListItems hero = facultyCourseListDashboardListItems.get(position);
        ...
        relative1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               // Intent facultyintent = new Intent(context, FacultyFeedbackDashboard.class);
                Intent facultyintent = new Intent(context, FacultyFeedbackScheduleDisplay.class);
        ...
        relative2.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent facultyintent = new Intent(context, FacultyFeedbackCummulativeScheduleDisplay.class);
                facultyintent.putExtra("coursename",coursename);
                facultyintent.putExtra("faculty_employeeid",hero.getFaculty_employeeid());
                facultyintent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                context.startActivity(facultyintent);
