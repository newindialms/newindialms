...
public class ProgramScreenYearStudentName extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Studentpic_programstudentname_title = findViewById(R.id.Studentpic_programstudentname_title);
        Studentpic_programstudentname_title.setText(YearList);
        heroList = new ArrayList<>();
        listView = findViewById(R.id.studentpic_programscreenyearstudentnamelist_ListView);
