...
public class StudentAcademicCalendar extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        subj1 = rootview.findViewById(R.id.sub1);
        subj2 = rootview.findViewById(R.id.sub2);
        subj3 = rootview.findViewById(R.id.sub3);
        subj4 = rootview.findViewById(R.id.sub4);
        note1 = rootview.findViewById(R.id.note_one);
        note2 = rootview.findViewById(R.id.note_two);
