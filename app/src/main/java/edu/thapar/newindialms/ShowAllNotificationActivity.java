...
import static edu.thapar.newindialms.R.id.toolbar_all_notiifcation;

public class ShowAllNotificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar_all_notification = (Toolbar) findViewById(toolbar_all_notiifcation);
        ...
        new GetHttpResponse(ShowAllNotificationActivity.this).execute();
        ...
        StudentListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(ShowAllNotificationActivity.this, EmailActivity.class);
                    ...
                    if (JSonResult != null) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                student.StudentEmail = jsonObject.getString("emailid").toString();
