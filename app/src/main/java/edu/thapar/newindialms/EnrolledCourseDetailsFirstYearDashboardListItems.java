...
public class EnrolledCourseDetailsFirstYearDashboardListItems {
    ...
    public EnrolledCourseDetailsFirstYearDashboardListItems(String programname) {
        this.programname = programname;
    }

    public EnrolledCourseDetailsFirstYearDashboardListItems(String courseDetailsSchedule, String courseDetailsDetails, String courseDetailsNotification, String courseDetailsMarks, String programname) {
