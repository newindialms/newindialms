...
public class FacultyFeedbackRateDisplay extends AppCompatActivity {
    ...
    public static final String rate_url = "https://www.newindialms.com/get_all_rate_feedback.php";
    ...
    List<FacultyFeedbackRateDisplayListItems> heroList;
    ListView listView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_faculty_ratefeedback_dashboard);
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (array != null && array.length() > 0) {
                        ...
                        adapter = new FacultyFeedackRateDisplayAdapter(getApplicationContext(), R.layout.activity_faculty_ratefeedback_dashboard_listitems, heroList);
                        listView.setAdapter(adapter);
                    } else {
                        //Toast.makeText(FacultyScheduleDisplay.this,"inside else",Toast.LENGTH_LONG).show();
                        builder = new AlertDialog.Builder(FacultyFeedbackRateDisplay.this, R.style.MyFacultyAlertDialogStyle);
