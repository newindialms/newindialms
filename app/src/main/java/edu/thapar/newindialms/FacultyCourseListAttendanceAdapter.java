...
public class FacultyCourseListAttendanceAdapter extends ArrayAdapter<FacultyCourseListAttendanceListItems> {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView faculty_courselist_attendance_take = view.findViewById(R.id.faculty_courselist_attendance_take);
        ImageView faculty_courselist_rightarrow1 = view.findViewById(R.id.faculty_courselist_rightarrow1);
        TextView faculty_courselist_attendance_see = view.findViewById(R.id.faculty_courselist_attendance_see);
